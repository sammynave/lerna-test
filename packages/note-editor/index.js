(function (global, factory) {
	...
	(global.LovepopTestNoteEditor = factory());
	...
	/* src/index.html generated by Svelte v2.15.1 */
	...
	function create_main_fragment(component, ctx) {
		...
		return {
			...
			p(changed, _ctx) {
				...
				if (('promise' in changed) && promise !== (promise = ctx.promise) && handlePromise(promise, info)) ; else {
	...
	function create_then_block(component, ctx) {
		var p, text0, text1_value = ctx.typeset, text1, text2;
		...
		return {
			...
			p(changed, ctx) {
				if ((changed.promise) && text1_value !== (text1_value = ctx.typeset)) {
